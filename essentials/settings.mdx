...
description: "Monkey Real Estate Management gives you complete control over the look and feel of your documentation using the monkey.json file"
icon: "gear"
---

Every Monkey Real Estate Management site needs a `monkey.json` file with the core configuration settings. Learn more about the [properties](#properties) below.

## Properties

<ResponseField name="name" type="string" required>
Name of your real estate project. Used for the global title.

Example: `MonkeyRealEstate`
...
<ResponseField name="topbarLinks" type="TopbarLink[]">
  ...
  <Expandable title="TopbarLink">
    ...
    Example: `Contact Property Manager`
    </ResponseField>
    <ResponseField name="url" type="string">
    The url once you click on the button. Example: `https://monkeyrealestate.com/contact`
    </ResponseField>
...
<ResponseField name="openapi" type="string | string[]">
  ...
  <CodeGroup>
    ```json Absolute
    "openapi": "https://monkeyrealestate.com/openapi.json"
    ```
    ```json Relative
    "openapi": "/openapi.json"
    ```
    ```json Multiple
    "openapi": ["https://monkeyrealestate.com/openapi1.json", "/openapi2.json", "/openapi3.json"]
    ```
  </CodeGroup>
...
<ResponseField name="footerSocials" type="FooterSocials">
  ...
  ```json
  {
    "x": "https://x.com/monkeyrealestate",
    "website": "https://monkeyrealestate.com"
  }
  ```
  <Expandable title="FooterSocials">
    ...
    Example: `https://x.com/monkeyrealestate`
    </ResponseField>
  </Expandable>
</ResponseField>
